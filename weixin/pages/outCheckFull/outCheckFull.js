        ...
        wx.request({
          ...
          success: (res) => {
            if (res.data.code == "200") {
              // var index = allCylinderList.indexOf(allCylinderList[i]);
              // if (index > -1) {
              //   allCylinderList.splice(index, 1);
              //   that.setData({
              //     allCylinderList: allCylinderList
              //   })
              // }
              console.log(JSON.stringify(allCylinderList));
              var index1 = allCylinderList.indexOf(allCylinderList[i]);
              // var index2 = setCylinderList.indexOf(allCylinderList[i]);
              // var index3 = cylinderList.indexOf(allCylinderList[i].cylinderNumber);
              // if(allCylinderList[i].setId != null) {
              //   let currentAllCylinderList = that.data.allCylinderList;
              //   let count = 0;
              //   for(let k=0; k<currentAllCylinderList.length; k++) {
              //     if (currentAllCylinderList[k].setId == allCylinderList[i].setId) {
              //       count += 1;
              //     }
              //   }
              //   if(count = 1) {
              //     var index4 = setList.indexOf(allCylinderList[i].setId);
              //   }
              // }
              ...
              // if (index2 > -1) {
              //   setCylinderList.splice(index2, 1);
              //   that.setData({
              //     setCylinderList: setCylinderList
              //   })
              //   that.setGlobal();
